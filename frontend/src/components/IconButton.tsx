...
export const IconButton = ({
  ...
  // Variant-based classes with opacity on hover
  const variantClasses = {
    ...
    text: 'bg-transparent text-white hover:opacity-70',
    outline: 'bg-transparent border border-zinc-600 text-white hover:opacity-50 hover:border-white',
  ...
  const baseClasses = [
    ...
    'focus-visible:ring-offset-bg-0',
    sizeClasses[size],
